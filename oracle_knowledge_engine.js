...
const ORACLE_KNOWLEDGE = {
  ...
  entries: [
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // SECTION 21: ZARA'S BOTANY & ALIEN SEEDING
    // Source: ALIEN_SEEDING_AND_CANNABIS_RESEARCH.md, CANON_AUDIT_2026-08-28.md
    // ═══════════════════════════════════════════════════════════════════════════

    {
      id: 'zara_plants',
      category: 'characters',
      keywords: ['zara plants', 'zara grows', 'zara garden', 'zara food', 'what does zara grow', 'zara apartment', 'zara green thumb', 'apartment jungle'],
      question_patterns: ['what does zara grow', 'zara plants', 'zara garden', 'does zara grow things', 'zara apartment plants'],
      answer: 'Zara grows EVERYTHING. Her apartment is a living jungle — walls of trailing pothos with dinner-plate leaves, ceiling ferns, a four-foot basil tree, orchids that bloom continuously (they shouldn\'t), and a massive fiddle leaf fig that has never dropped a leaf. She runs indoor grow shelves with year-round lettuce, cherry tomatoes, strawberries, and hot peppers. She makes her own medicinal teas from chamomile, lemon balm, echinacea, and a dozen other herbs she grows. She has a secret grow house in a separate building for her cannabis strains. Her produce is unnaturally nutritious — people feel more full, think clearer, sleep better. She gives food away constantly ("I always grow too much") and keeps her sister Lena on a steady diet of her produce as a protective measure. The plants are the ONE thing she never neglects.',
      related: ['zara', 'zara_alien_nature', 'zara_strains', 'alien_seeding'],
...

    {
      id: 'zara_strains',
      category: 'characters',
      keywords: ['zara strains', 'event horizon', 'third octave strain', 'keynote kush', 'zero point', 'sorens garden', 'soren garden', 'zara weed', 'zara cannabis'],
      question_patterns: ['what are zara strains', 'zara cannabis', 'event horizon strain', 'keynote kush', 'zero point strain', 'soren garden', 'what weed does zara grow'],
      answer: 'Zara cultivates five unique strains that don\'t match anything in any seed bank database. EVENT HORIZON: Purple-black coloration, silver trichomes — causes actual perceptible time dilation. People get "extra time" inside an idea. THIRD OCTAVE: Sativa-dominant, smells like a library on another planet — auditory enhancement. Music becomes spatial. People hear architecture in songs. KEYNOTE KUSH: Heavy indica, buds like fists — grounds you completely into physical sensation. Not sleepy, PRESENT. ZERO POINT: Fractal flower structure, perfectly balanced terpenes — neutrality. Mental chatter stops. She screens recipients. SOREN\'S GARDEN: Her most personal strain, named for someone she lost. The terpene profile shifts per batch. Effect: compassion. People feel held by something larger. They call their mothers. Her strains have never caused paranoia in anyone (statistically impossible for high-THC cannabis).',
      related: ['zara_plants', 'zara_alien_nature', 'zara'],
      source: 'ALIEN_SEEDING_AND_CANNABIS_RESEARCH.md'
    },

    {
      id: 'zara_food_effects',
      category: 'characters',
      keywords: ['zara food', 'zara food effects', 'why zara food different', 'zara produce', 'zara nutrition', 'food quality', 'feel full'],
      question_patterns: ['why is zara food different', 'why does zara food taste better', 'zara food effects', 'what happens when you eat zara food'],
      answer: 'People who eat Zara\'s food regularly feel more energetic, get sick less often, sleep better, heal faster, feel "more full" from smaller amounts, and gradually start craving whole foods over processed food. This isn\'t magic — it\'s nutritional density. Modern commercial produce has lost 50-80% of its mineral content since the 1940s. Zara\'s living soil contains the mineral profiles that Earth\'s soil USED to have. Her plants express their full genetic potential — every vitamin, mineral, and phytonutrient. Beyond the mineral density, her food carries a subtle resonance from the frequency cultivation and "informed" water she uses. People who eat it regularly report feeling "clearer" — not just nourished but aligned. She frames it as nothing: "Oh, this was about to go bad anyway." Nobody notices the pattern.',
      related: ['zara_plants', 'zara_alien_nature', 'alien_seeding'],
      source: 'ALIEN_SEEDING_AND_CANNABIS_RESEARCH.md'
    },

    {
      id: 'alien_seeding',
      category: 'world',
      keywords: ['alien seeding', 'directed panspermia', 'plants from space', 'seeded plants', 'alien plants', 'crick panspermia', 'plants seeded', 'gardeners'],
      question_patterns: ['alien seeding', 'directed panspermia', 'were plants seeded by aliens', 'plants from space', 'did aliens seed earth'],
      answer: 'Directed Panspermia is the theory (proposed by Nobel laureate Francis Crick in 1973) that life on Earth was deliberately seeded by an advanced civilization. In Signal Decay\'s universe, this is TRUE — and it\'s what Zara\'s people DO. They don\'t colonize planets. They GARDEN them. Staged seeding over billions of years: microbes first, then increasingly complex organisms, then specific agricultural packages (wheat, corn, rice) to trigger civilization. They also seeded psychedelic plants as "tuning devices" — cannabis for subtle perception enhancement, psilocybin for neurogenesis, ayahuasca as a "communication channel." The endocannabinoid system in humans was ENGINEERED to ensure mammals would seek out and cultivate cannabis. Zara knows this because she IS evidence of it. The Sumerian texts about gods teaching agriculture? That\'s the closest human record to what actually happened — filtered through millennia of cultural translation.',
      related: ['zara_alien_nature', 'zara_plants', 'stoned_ape_theory', 'frequency_cultivation'],
      source: 'ALIEN_SEEDING_AND_CANNABIS_RESEARCH.md'
    },

    {
      id: 'stoned_ape_theory',
      category: 'world',
      keywords: ['stoned ape', 'stoned ape theory', 'mckenna', 'terence mckenna', 'psychedelic plants', 'mushrooms evolution', 'psilocybin brain', 'psychedelic evolution'],
      question_patterns: ['stoned ape theory', 'did mushrooms make us smart', 'psychedelic plants evolution', 'mckenna theory'],
      answer: 'The Stoned Ape Theory (Terence McKenna, 1992) proposes that psilocybin mushrooms catalyzed the evolution of Homo erectus into Homo sapiens — enhancing visual acuity at low doses, increasing arousal and social bonding at medium doses, and triggering language, symbolic thought, and art at high doses. The human brain tripled in size in a remarkably short period with no satisfactory explanation. In Signal Decay\'s universe, the UFOlogy extension asks: what if the mushrooms were PLACED there deliberately? An elegant solution — engineer a fungus that grows on ubiquitous animal dung and triggers neurogenesis. No surgery needed. Just leave a gift in the field. This is Zara\'s philosophy of cultivation: she doesn\'t force growth, she creates conditions for it. Jude actually read about this in prison — "wait so you\'re saying mushrooms made us smart?? that\'s wild."',
      related: ['alien_seeding', 'zara_alien_nature', 'frequency_cultivation'],
      source: 'ALIEN_SEEDING_AND_CANNABIS_RESEARCH.md'
    },

    {
      id: 'frequency_cultivation',
      category: 'concepts',
      keywords: ['frequency cultivation', 'growing with sound', 'growing with frequency', '528 hz', '432 hz', 'plant frequency', 'sound growing', 'alien growing techniques'],
      question_patterns: ['frequency cultivation', 'growing with sound', 'how does zara use frequency to grow', 'plant frequency', '528 hz plants', '432 hz plants'],
      answer: 'Zara uses precise frequency techniques during cultivation that no human grower employs. She plays specific electromagnetic and acoustic waveforms during different growth stages using a device she built from components that shouldn\'t work together. Vegetative frequencies promote cellular division (plants grow 30-40% faster). Flowering frequencies stimulate trichome production and DIRECT which terpenes express. Night frequencies — a barely-perceptible hum during dark period — affect root-mycorrhizal communication. She also uses "star spectrum" lights that include wavelengths LED manufacturers don\'t produce, mimicking peaks from the star her plants originally evolved under. Her off-world nutrient formulas contain mineral compounds matching no geological profile on Earth. To her, this isn\'t magic — it\'s technology. Simple, even boring. Like a human might think of a grow light.',
      related: ['zara_plants', 'zara_strains', 'alien_seeding', 'zara_alien_nature'],
      source: 'ALIEN_SEEDING_AND_CANNABIS_RESEARCH.md'
    },

    {
      id: 'zara_restraint',
      category: 'characters',
      keywords: ['zara restraint', 'why zara stays small', 'zara could revolutionize', 'zara hiding', 'zara agriculture', 'zara scale'],
      question_patterns: ['why doesn\'t zara grow more', 'why does zara stay small', 'could zara revolutionize farming', 'zara restraint'],
      answer: 'Zara could revolutionize agriculture, solve food deserts, produce medicines that would embarrass pharmaceutical companies, and get very rich. She doesn\'t because: (1) Scale requires infrastructure which requires people who talk — she cannot be noticed. (2) Exceptionalism draws attention — one talented grower is fine, consistent supernatural perfection is an ANOMALY that gets investigated. (3) Money traces — sudden wealth with no paper trail is a red flag for Legacy detection. (4) She has a mission that isn\'t "become a weed baron" — every expansion risks her primary purpose. (5) If too many depend on her supply, she can\'t disappear if needed. (6) Ethical code: you don\'t overwhelm an ecosystem, you work at the edge, you leave room for self-correction. She keeps it to 4-6 plants flowering, 2-3 lbs/year, gifts only, never sales. Invisible footprint.',
      related: ['zara_plants', 'zara_alien_nature', 'the_legacy'],
      source: 'ALIEN_SEEDING_AND_CANNABIS_RESEARCH.md'
    },
