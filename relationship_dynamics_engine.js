...
// ══════════════════════════════════════════════════════════════════════════
// ➕ ENHANCEMENT — Sep 7 2026: REAL-WORLD ATTACHMENT-THEORY GROUNDING
// ══════════════════════════════════════════════════════════════════════════
// ADDITIVE ONLY. No existing fields were removed or modified. This pass adds
// three new sections and four utility functions that ground the narrative
// relationship model in peer-reviewed psychology research:
//
//   SECTION 9  — attachment_basis: per-character adult attachment styles
//                (Kael=avoidant, Mira=anxious, Oren=secure, Jude=fearful-
//                avoidant→earned-secure, Zara=non-standard/alien, Lena=secure-
//                leaning) + how each band pair's styles interact.
//   SECTION 10 — trust_repair_notes: Gottman Atone→Attune→Attach model,
//                Betrayal Trauma Theory, trickle-truth, recoverable-vs-not,
//                and numerical hooks into the Section 5 trust matrix.
//   SECTION 11 — loyalty_psychology: Milgram/Asch obedience & conformity,
//                moral courage, moral injury, and identity-fusion predictions
//                of who actually self-sacrifices vs. who only says they would.
//
//   New utilities: getAttachmentProfile, getPairAttachmentDynamic,
//                  getTrustRepairApplication, getLoyaltyUnderPressure.
//
// Sources: RELATIONSHIP_PSYCHOLOGY_RESEARCH.md, RELATIONSHIP_DYNAMICS_RESEARCH.md
//          (Bowlby, Ainsworth, Hazan & Shaver, Bartholomew & Horowitz, Sue
//          Johnson EFT, Gottman, Freyd, Roisman, Milgram, Asch, Swann fusion).
// ══════════════════════════════════════════════════════════════════════════
...
const RELATIONSHIP_DYNAMICS_ENGINE = {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // SECTION 9: ATTACHMENT BASIS  (Real-World Psychology Enhancement — Sep 7 2026)
  // ═══════════════════════════════════════════════════════════════════════════
  // ADDITIVE ENHANCEMENT. Grounds each character and each band pair in
  // evidence-based adult attachment theory (Bowlby/Ainsworth → Hazan & Shaver
  // → Bartholomew & Horowitz four-category model; Mikulincer & Shaver 2007).
  // Nothing above this line was removed. These fields SUPPLEMENT the narrative
  // states in Sections 1-8 with the psychology research they were built on.
  //
  // The four adult styles (Bartholomew & Horowitz, 1991):
  //   secure          — low anxiety, low avoidance ("I'm worthy; others reliable")
  //   anxious         — high anxiety, low avoidance ("they might leave me")
  //   avoidant        — low anxiety, high avoidance ("closeness is dangerous")
  //   fearful/disorg. — high anxiety, high avoidance ("I want it but it destroys me")
  // Population base rates (Mickelson/Kessler/Shaver 1997): secure ~59%,
  // avoidant ~25%, anxious ~11%, fearful-avoidant ~5%.
  // ═══════════════════════════════════════════════════════════════════════════

  attachment_basis: {

    // Per-character attachment profiles. Baselines drawn from the Signal Decay
    // research files (Character Baseline Profiles table). Anxiety/avoidance on
    // 0-100 dimensional scales (ECR-R style), NOT discrete boxes.
    characters: {
      ...
      kael: {
        ...
        avoidance: 75,
        stability: 55,
        internal_model: "I don't need anyone; closeness is dangerous. Needing people equals vulnerability equals pain.",
        behavioral_signature: "Deactivation under stress — suppresses emotion, intellectualizes, creates distance. 'I need space' is the default. Chosen silence is his containment strategy.",
        core_wound: "Learned early that being needed and being seen are threats. His Resonant Command means every emotional demand he makes could literally overwrite someone — so withdrawal became doubly safe.",
        empathic_blind_spot: "Overall et al. (2015): avoidant individuals are specifically worse at perceiving POSITIVE emotion in others — their defensive system filters out evidence that people care. Kael literally under-registers how loved he is.",
        growth_vector: "Reaching through the wall FIRST, unprompted, during someone else's crisis. Each time he approaches instead of withdrawing, his avoidance score drops a point.",
        research_basis: "Bartholomew & Horowitz (1991); Overall, Girme & Simpson (2015); Mikulincer & Shaver (2007) — avoidant members contribute stability through emotional containment but frustrate through unavailability."
      },
      ...
      mira: {
        ...
        avoidance: 20,
        stability: 35,
        internal_model: "I need others to validate my worth, and they might leave. Ambiguity reads as rejection.",
        behavioral_signature: "Hyperactivation under stress — amplifies attachment signals, seeks reassurance, monitors others' emotional states, protest behaviors (over-texting, 'where do we stand', emotional flooding). Panic-oversharing when scared.",
        core_wound: "Lifelong isolation — living kids avoided her; her only companions were dead musicians. Any sign that LIVING people might also leave activates existential terror.",
        group_function: "The 'smoke detector' (Mikulincer & Shaver 2007): anxious individuals detect relational threats first. Mira notices tension in the band before anyone else — a genuine asset when channeled.",
        growth_vector: "Naming the fear underneath the protest ('I'm scared you'll leave') instead of acting it out ('why don't you ever talk to me?'). This is the EFT-defined break in the pursue-withdraw cycle.",
        research_basis: "Bartholomew & Horowitz (1991); Sue Johnson EFT (2008); Simpson, Rholes & Phillips (1996) — anxious-with-avoidant pairings show the greatest observed distress."
      },
      ...
      oren: {
        ...
        avoidance: 15,
        stability: 85,
        internal_model: "I'm worthy of love and others are reliable. Comfortable with both intimacy and independence.",
        behavioral_signature: "Turns toward bids for connection. Regulates his own emotion and co-regulates others'. His compulsive warmth/chatter is his bonding channel, not neediness.",
        group_function: "GROUP STABILIZER. A secure member functions as a living 'security prime' (Mikulincer & Shaver 2001-2007): mere proximity to Oren downregulates others' threat responses. Partner-buffering (Simpson & Rholes 2017): anxious people near him get calmer, avoidant people near him get warmer.",
        caveat: "His time-skips are a NEUROLOGICAL vulnerability, not an attachment one — his security holds even when his temporal continuity does not.",
        growth_vector: "Already secure; his arc is learning to receive care, not only give it, and to sit in silence (which Kael teaches him).",
        research_basis: "Coan, Schaefer & Davidson (2006) 'Lending a Hand' fMRI; Fredrickson broaden-and-build; Mikulincer & Shaver security-priming studies."
      },

      jude: {
        character: "Jude Okafor",
        style: "fearful-avoidant (disorganized) trending toward earned-secure",
        anxiety: 60,
        avoidance: 65,
        stability: 30,
        internal_model: "I want connection but it always hurts. Approach and withdrawal fire at the same time.",
        behavioral_signature: "Oscillation — desire for belonging paired with terror of it. Prison amplified BOTH dimensions (hypervigilance + emotional suppression). Tests relationships by escalating negative behavior to see who stays.",
        earned_secure_path: [
          "Stage 1 Testing (trust 0-20): provokes conflict, breaks small rules, tests loyalty.",
          "Stage 2 Tentative approach (20-40): small vulnerability disclosures; single betrayal resets to 0.",
          "Stage 3 Corrective experience (40-60): someone (likely Oren) does the OPPOSITE of what trauma predicts.",
          "Stage 4 Reciprocal vulnerability (60-75): Jude offers unasked support to another — the giving is the healing.",
          "Stage 5 Integration (75-90): narrates his story coherently — acknowledges pain without drowning in it. Earned secure."
        ],
        regression_note: "Roisman et al. (2002): earned-secure individuals REGRESS to fearful-avoidant patterns under extreme stress. Jude always carries the old wiring — the difference is he recovers faster and knows what's happening.",
        research_basis: "Roisman et al. (2002); Pearson et al. (1994); Dansby-Olufowote et al. (2019); Sampson & Laub desistance research — new prosocial bonds (the band) enable identity reconstruction."
      },

      zara: {
        character: "Zara / Za-Rah",
        style: "non-standard (alien consciousness — outside the anxiety/avoidance grid)",
        anxiety: null,
        avoidance: null,
        stability: 70,
        internal_model: "Attachment is a phenomenon she OBSERVES rather than one she is driven by. She finds the human need for permanence fascinating rather than frightening.",
        alien_mapping: {
          instead_of_anxiety: "Curiosity — she studies others' attachment the way a scientist observes data; she does not fear abandonment.",
          instead_of_avoidance: "Calibration difficulty — not discomfort with closeness but a processing lag; her signal runs on a different frequency.",
          instead_of_protest: "Information gathering — when something goes wrong she asks WHY, not 'do you still love me?' (reads as cold; is actually deep engagement).",
          secure_base: "Lena. Her one true human anchor point — where her capacity to connect is proven."
        },
        uncanny_valley: "Others sense something 'off' — she says the right thing a beat too late, answers emotion with logic. Mirrors alexithymia research (Taylor, Bagby & Parker 1997): perceived as robotic, but bonds real — expressed through ACTION (cooking, showing up) not words.",
        numerical_model: "No standard anxiety/avoidance. Instead: attunement_accuracy (0-100, starts ~40, rises with band exposure, drops under stress); connection_depth per-person (Lena 95, band 30-50, outsiders ~0).",
        research_basis: "Schore (2001, 2003) attachment as neurobiological right-brain process; Bartholomew (1990); Taylor, Bagby & Parker (1997) alexithymia."
      },

      lena: {
        character: "Lena Kovac",
        style: "secure-leaning (adolescent flux)",
        anxiety: 40,
        avoidance: 25,
        stability: 50,
        internal_model: "Basically trusting, but destabilized by past-life memories bleeding through that she can't explain to anyone.",
        note: "Her secure base is Zara — trust toward Zara ~80, toward the band ~30. Adolescent identity flux plus non-terrestrial frequency exposure keeps her scores mobile.",
        research_basis: "Fraley & Davis (1997) attachment-function transfer to peers in adolescence."
      }
    },

    // How each band pair's styles interact — the dyad-level psychology behind
    // the narrative in Section 1. Keys match the pairwise keys exactly.
    pair_dynamics: {

      kael_mira: {
        pairing: "avoidant (Kael) × anxious (Mira) — the classic ANXIOUS-AVOIDANT TRAP",
        dynamic: "The single most-studied insecure pairing (Sue Johnson EFT). Highest observed distress of any combination (Simpson et al. 1996). Mira's hyperactivation triggers Kael's deactivation, which reads to Mira as abandonment, which escalates her pursuit, which triggers more of his withdrawal.",
        pursue_withdraw_cycle: "Trigger to bond -> Mira anxiety spikes ('are we okay?') -> Kael overwhelm spikes, withdraws ('I need space') -> Mira reads withdrawal as rejection, anxiety doubles -> escalated pursuit -> Kael stonewalls -> cooling period -> Kael guilt + small reconnection gesture -> Mira relief, over-interprets -> reset. Repeats every 2-14 days in distressed pairs (Christensen & Heavey 1990).",
        thresholds: "Mira baseline anxiety ~45 (spikes 80+ on perceived rejection). Kael tolerates emotional intensity to ~55 before deactivating; Mira's baseline output ~50 sits right at his edge — which is why they're both drawn to and stressed by each other.",
        what_breaks_the_cycle: "Kael reaching through the wall FIRST without being demanded; Mira naming the fear ('I'm scared you'll leave') instead of protesting. Crucially, their MUSIC bypasses the verbal attachment system — synchronized creation produces physiological co-regulation (Feldman 2007) that can repair ruptures words can't.",
        why_it_can_work: "The trap is only a trap while both stay in default mode. The narrative arc (Section 1: dormant->awakened) IS the de-escalation of this cycle into secure functioning.",
        research_basis: "Johnson (2008); Conradi et al. (2021); Simpson, Rholes & Phillips (1996); Feldman (2007)."
      },

      kael_oren: {
        pairing: "avoidant (Kael) × secure (Oren) — partner-buffering, low friction",
        dynamic: "Simpson & Rholes (2017): a secure partner gradually softens an avoidant one. Oren's security is a living security-prime; Kael's amygdala quiets in his presence — which the story literalizes as Oren's time-skips stopping near Kael. The residual friction is a love-language mismatch: Oren wants to TALK, Kael wants to SHOW.",
        trajectory: "Avoidance decreases over arc states as Oren models that closeness is safe and undemanding. This is the lowest-tension band pair for exactly the reason research predicts: secure buffers avoidant.",
        research_basis: "Simpson & Rholes (2017) partner buffering; Mikulincer & Shaver (2007)."
      },

      kael_jude: {
        pairing: "avoidant (Kael) × fearful-avoidant (Jude) — two high-avoidance containers",
        dynamic: "Both deactivate; neither pursues. This produces a paradoxically STABLE, low-demand bond — mutual recognition without mutual pressure. Neither triggers the other's abandonment alarm because neither reaches. Risk: it can plateau at 'safe distance' unless a corrective event forces vulnerability.",
        jude_testing: "Jude's testing repertoire lands softly on Kael — Kael's non-retaliatory withdrawal reads to Jude as 'passed the test' (he stayed AND didn't hit back). Kael is an easy early trust-win for Jude.",
        research_basis: "Bartholomew & Horowitz (1991); Winnicott (1965) object-relations testing."
      },

      kael_zara: {
        pairing: "avoidant (Kael) × non-standard (Zara)",
        dynamic: "Kael's deactivation meets Zara's calibration-lag; both under-emote by human standards, so neither pressures the other. Kael's frequency sensitivity means he is the band member most likely to SENSE Zara's concealment (her body language leaking) even before he understands it — creating watchful, respectful distance rather than anxiety.",
        research_basis: "Schore (2001); Taylor, Bagby & Parker (1997) alexithymia expressed through action."
      },

      mira_oren: {
        pairing: "anxious (Mira) × secure (Oren) — the calming pairing",
        dynamic: "Partner-buffering at its most beneficial: an anxious person paired with a secure one gradually becomes less anxious (Simpson & Rholes 2017). Oren's consistent, non-contingent warmth is exactly the 'explicit, sustained reassurance' that drops Mira's anxiety below 30. He is her emotional shock-absorber.",
        research_basis: "Simpson & Rholes (2017); Coan et al. (2006)."
      },

      mira_jude: {
        pairing: "anxious (Mira) × fearful-avoidant (Jude)",
        dynamic: "High-stakes but high-potential. Mira's pursuit could trigger Jude's withdrawal (his avoidance dimension) OR her transparent vulnerability could disarm his testing (she leaks truth, proving she's not concealing threat). The research-backed turning point: Jude approaching a struggling Mira FIRST (earned-secure Stage 4) — his own parallel pain making him safe to her, her acceptance updating his model.",
        research_basis: "Bartholomew & Horowitz (1991); Dansby-Olufowote et al. (2019) reciprocal-vulnerability stage."
      },

      mira_zara: {
        pairing: "anxious (Mira) × non-standard (Zara)",
        dynamic: "Mira's hypervigilance makes her the band member most likely to sense that Zara's warmth is 'a beat off' — she reads the uncanny-valley signal others miss. Handled well, this becomes intimacy (Mira accepts the difference the way she wants her own difference accepted); handled poorly, it feeds Mira's rejection-radar.",
        research_basis: "Mikulincer & Shaver (2007) anxious-as-smoke-detector; Taylor et al. (1997)."
      },

      oren_jude: {
        pairing: "secure (Oren) × fearful-avoidant (Jude) — the CORRECTIVE relationship",
        dynamic: "This is the single most important dyad for Jude's earned-secure arc. Oren is the character positioned to deliver the 'corrective relational experience' (Roisman 2002; Dansby-Olufowote 2019) — doing the OPPOSITE of what Jude's trauma predicts: sacrificing for him without asking for anything, staying through the tests, enforcing consequences without exile. Secure base meets the person who most needs one.",
        mechanism: "Each passed test spikes Jude's anxiety briefly (the wall is being dismantled — terrifying) then settles him at a LOWER baseline. After ~5 consecutive passed tests, testing frequency drops sharply — the 'oh, they actually care' threshold.",
        research_basis: "Roisman et al. (2002); Dansby-Olufowote et al. (2019); Sampson & Laub — new prosocial bonds enable 'I'm not who I was.'"
      },

      oren_zara: {
        pairing: "secure (Oren) × non-standard (Zara)",
        dynamic: "Oren's security means he extends warmth without needing Zara to reciprocate on a human timetable — he tolerates her calibration-lag better than anyone, giving her attunement_accuracy room to rise. Notably the LAST relationship to fully seal in the awakened matrix (Oren learned the Samir truth last), so residual hurt lingers here longest even as trust is high.",
        research_basis: "Mikulincer & Shaver (2007); Simpson & Rholes (2017)."
      },

      jude_zara: {
        pairing: "fearful-avoidant (Jude) × non-standard (Zara)",
        dynamic: "Two concealers who recognize concealment in each other. Jude's 'identify the snitch' testing meets Zara's professional-grade secret-keeping — she passes his containment tests effortlessly because she has hidden a cosmic identity for 25 years. Mutual respect for the discipline of hiding builds an early, quiet trust (note their comparatively high dormant trust in the matrix).",
        research_basis: "Rotter et al. (2005) incarceration culture; Freyd betrayal-trauma calibration."
      }
    }
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // SECTION 10: TRUST REPAIR NOTES  (Real-World Psychology Enhancement — Sep 7 2026)
  // ═══════════════════════════════════════════════════════════════════════════
  // ADDITIVE ENHANCEMENT. Evidence-based scaffolding for how trust breaks and
  // rebuilds in Signal Decay. Complements Section 5 (trust_matrix) and
  // Section 6 (event_triggers) with the mechanics behind the numbers.
  // ═══════════════════════════════════════════════════════════════════════════

  trust_repair_notes: {

    // How trust is BUILT in the first place (before any repair is needed).
    trust_formation: {
      three_perceptions: "Mayer, Davis & Schoorman (1995): trust = Ability ('can they do what they say?') + Benevolence ('do they care about me?') + Integrity ('are they predictable by principle?'). In the band, ability proves fast (a rehearsal), benevolence medium, integrity slowest — it requires time and testing.",
      three_stages: "Lewicki & Bunker (1995): (1) Calculus-based ('cost of betrayal is high — we need each other') = dormant band; (2) Knowledge-based ('I trust you because I know your patterns') = emerging; (3) Identification-based ('we ARE Signal Decay') = awakened.",
      fast_friends: "Aron et al. (1997): structured, reciprocal, escalating self-disclosure creates months-worth of closeness in ~45 minutes. For Signal Decay the escalation runs through MUSIC first (sharing a song written alone = emotional exposure), then words.",
      asymmetry: "Slovic (1993): trust is built slowly and destroyed quickly. A single betrayal can undo months. Recovery takes 2-4x longer than the original formation."
    },

    // The Gottman three-phase repair model — the master template for any
    // in-story betrayal recovery (Ashley Cole, Zhao, intra-band lies).
    gottman_atone_attune_attach: {
      phase_1_atonement: "Betrayer takes full, non-defensive responsibility. COMPLETE transparency — no trickle-truth. Cut ties with the source of betrayal. Proactive openness (resisting transparency signals the impact isn't understood). No defensive counter-accusations — the betrayer is 100% responsible for going outside the bond.",
      phase_2_attunement: "Both parties examine what made the relationship vulnerable (to understand, not to blame). Rebuild the 'friendship system' — knowing each other's inner worlds, turning toward bids. Build a NEW relationship, not a return to the old one. Address the Four Horsemen (Criticism, Contempt, Defensiveness, Stonewalling).",
      phase_3_attachment: "Genuine forgiveness emerges — cannot be rushed or demanded. Renewed commitment based on the work done, not naive hope. The betrayer does NOT get to decide when reassurance ends; the betrayal becomes part of shared history, held without defining the bond.",
      source: "Gottman Institute clinical model (ongoing RCT); Julie & John Gottman."
    },

    // The single most dangerous pattern in repair.
    trickle_truth_problem: "When the full story emerges in pieces, the betrayed person experiences each new revelation as a FRESH, intentional betrayal. Many betrayed people report the lies AFTER the betrayal were harder to process than the betrayal itself. In Signal Decay, staggered reveals (Zara's concealment surfacing in layers; Zhao's role emerging slowly) are powerful narrative fuel precisely because each layer reopens the wound.",

    // Competence vs. integrity violations respond to opposite strategies.
    violation_type_matters: "Kim, Dirks, Cooper & Ferrin (2006): for COMPETENCE violations (someone screwed up) an apology works best. For INTEGRITY violations (someone lied) denial is paradoxically more effective short-term — BUT only if true; once the lie is confirmed, trust collapses toward zero. Implication: intra-band lies are far more corrosive than intra-band mistakes.",

    // Betrayal Trauma Theory — why WHO betrays you determines the damage.
    betrayal_trauma_theory: "Freyd (1994, 1996): betrayal by someone you DEPEND ON is qualitatively worse than betrayal by a stranger, and produces DISSOCIATIVE responses (numbing, memory gaps) rather than hyperarousal. Proportionality rule for Signal Decay: a lie from Oren (the secure base) would devastate FAR more than a lie from Kael (already emotionally distant). Survivors mis-calibrate afterward — either trusting too easily or trusting no one (Freyd, DePrince & Gleaves 2007).",

    // The five research-backed repair behaviors (2025 systematic review).
    five_repair_behaviors: [
      "Proactive transparency — volunteer information without being asked.",
      "Active monitoring — allow the betrayed to verify (temporary loss of privacy as cost).",
      "Remorse and accountability — genuine emotional acknowledgment, not just a verbal apology.",
      "Shared activities — doing things together rebuilds IMPLICIT trust faster than talking (for the band: playing together).",
      "Clear communication of reasons — 'why did you do it?' must be answered honestly."
    ],

    // What makes a betrayal survivable — or not.
    recoverable_vs_unrecoverable: {
      recoverable_when: "Full non-defensive responsibility; both parties fully committed ('one foot out the door' makes recovery nearly impossible); trauma responses respected; consistent CHANGED BEHAVIOR (not words); the betrayer doesn't control the forgiveness timeline.",
      unrecoverable_when: "Betrayer stays defensive/minimizing; wound simply too deep despite genuine effort; CONTEMPT was present (Gottman's single best predictor of dissolution); relationship already severely damaged pre-betrayal; behavior continues; trickle-truth never ends.",
      contempt_is_the_killer: "Of the Four Horsemen, contempt is the strongest predictor of dissolution. A betrayal delivered or met WITHOUT contempt is far more recoverable than a smaller one soaked in it."
    },

    // Numerical hooks that plug into the existing trust_matrix values.
    numerical_model: {
      trust_scale: "0-100 per dyad (matches Section 5 matrix cells).",
      gain_rate: "+1 to +3 per positive interaction — slow accumulation.",
      loss_on_betrayal: "-30 to -70 depending on severity AND closeness (closer = worse, per Betrayal Trauma Theory).",
      recovery_rate: "50% of normal gain rate until a genuine 'repair event' occurs, then gradually returns to baseline.",
      jude_special_case: "Slowest accumulator of any character: +1 per passed test, -5 per failed test; a single betrayal in Stages 1-2 resets him to 0."
    },

    // Story-specific applications flagged in the research.
    story_applications: {
      ashley_cole_betrayal: "Map the Gottman phases directly. The dramatic question is whether Ashley reaches genuine Atonement or stalls in defensiveness. Show the 1-3 month acute-shock phase in the affected character's behavior. Trickle-truth is the engine.",
      zhao_defection: "A GROUP betrayal, not a dyadic one — recovery is harder because (1) each member processes it through their own attachment style, (2) the group can split into 'forgive' vs. 'never again' factions, (3) whoever was closest to Zhao pre-defection carries the deepest wound (see Section 7 for Zhao's per-member bonds).",
      zara_concealment: "Not a classic betrayal — closer to a sustained integrity question. Because Zara's benevolence is provable (the dampening field, the food) but her transparency is not, repair hinges on the band re-reading 25 years of hiding as protection rather than deceit."
    }
  },


  // ═══════════════════════════════════════════════════════════════════════════
  // SECTION 11: LOYALTY PSYCHOLOGY  (Real-World Psychology Enhancement — Sep 7 2026)
  // ═══════════════════════════════════════════════════════════════════════════
  // ADDITIVE ENHANCEMENT. The obedience/conformity/moral-courage research behind
  // Section 8 (loyalty_predictions). Predicts WHO breaks under pressure, WHO
  // resists, and WHO actually self-sacrifices vs. merely says they would.
  // ═══════════════════════════════════════════════════════════════════════════

  loyalty_psychology: {

    // Milgram: obedience to authority — and who defies it.
    obedience_milgram: {
      finding: "Milgram (1961-63): 65% obeyed an authority to the point of (believed) lethal harm — but 35% DEFIED.",
      who_defies: "Bègue et al. (2015): LOWER agreeableness (more questioning/contrarian) predicts defiance; higher agreeableness/conscientiousness predicts MORE obedience. Prior practice at defiance (activists) predicts resistance.",
      cascade_effect: "The single strongest situational lever: when one person defies FIRST, defiance jumps to ~90%. One visible resister gives everyone else permission.",
      signal_decay_application: "The first band member to defy an authority (the Conductor entity, the industry, a government agency) determines whether the group follows. This is a cascade — once one breaks ranks, the others CAN."
    },

    // Asch: conformity to the group — and who resists.
    conformity_asch: {
      finding: "Asch (1950s): ~75% conformed to an obviously-wrong group answer at least once — but 25% NEVER conformed.",
      who_resists: "Resisters showed higher self-esteem, internal locus of control, need for uniqueness, and confidence in their own perception.",
      ally_effect: "A single dissenter cut conformity by ~80%. You don't need a majority to hold the line — you need ONE other person. (Narrative lever: pair the wavering member with one steady ally.)"
    },

    // Per-character prediction of who breaks vs. who holds under group pressure.
    // These SUPPLEMENT Section 8's would_betray_under_pressure with the 'why'.
    who_breaks_under_pressure: {
      zara: "MOST LIKELY TO RESIST FIRST. Alien perspective means human authority structures carry no inherent weight — she simply doesn't register the pressure the others feel. Ideal cascade-starter.",
      oren: "MOST LIKELY TO RESIST ON MORAL GROUNDS. Secure attachment = an internal moral compass not dependent on group approval. He can stand alone without it costing him his sense of self.",
      mira: "MOST LIKELY TO CONFORM under direct pressure (anxious attachment fears conflict/rejection) — BUT the FIRST to NOTICE something is wrong (hypervigilance / smoke-detector). Her tension: she sees it early and says it late.",
      jude: "UNPREDICTABLE. Incarceration culture says both 'don't snitch' AND 'don't be played.' Which script fires depends on whether he reads the authority as a threat to the band (he resists hard) or a test of loyalty (he goes silent).",
      kael: "THE SWING VOTE. Avoidance means he's comfortable standing alone — but deactivation may SUPPRESS the moral signal at the critical moment. He can go either way; whoever resists first likely decides him."
    },

    // Whistleblower / moral-courage trait profile.
    moral_courage_profile: {
      traits: "Mesmer-Magnus & Viswesvaran (2005); Miceli, Near & Dworkin (2008): whistleblowers show strong ethical identity (morality is CORE, not peripheral), proactive personality, high positive affectivity (they care enough that violation hurts), moral courage, LOW agreeableness, and a history of prior activism.",
      highest_in_band: "Oren (ethical identity + proactivity) and Zara (immune to social pressure). Lowest situational likelihood: Mira (agreeableness + conflict-avoidance), though her early-detection makes her the informant who ENABLES a braver member to act."
    },

    // Moral injury — how a forced compromise fractures the group.
    moral_injury: {
      definition: "Litz et al. (2009): a potentially morally injurious event (PMIE) — witnessing, committing, or failing to prevent an act that violates one's moral beliefs — produces dissonance -> rumination -> guilt/shame -> withdrawal. Shay (1994): betrayal of 'what's right' by a legitimate authority is the most damaging form.",
      asymmetric_fractures: "Kidwell & Kerig (2023): the SAME event injures different members to different degrees based on their values. The injured member withdraws while others don't understand why — creating a silent rift.",
      per_character: {
        jude: "MOST VULNERABLE — his integrity is hard-won and therefore precious; a forced compromise threatens the identity he rebuilt.",
        oren: "Feels it deeply but can PROCESS it through secure attachment and co-regulation.",
        mira: "Prioritizes group cohesion OVER moral processing (anxious) — may suppress her own injury to keep the band together, at a later cost.",
        kael: "Intellectualizes and suppresses (avoidant processing of moral pain) — the injury goes underground rather than away.",
        zara: "May not register human moral categories the same way — what wounds the others may not wound her, and vice versa."
      }
    },

    // The gap between 'I'd die for you' and actually doing it.
    self_sacrifice_vs_verbal_loyalty: {
      finding: "Swann et al. (2014), identity-fusion research: over 90% SAY self-sacrifice for the group is the moral choice, but only STRONGLY FUSED individuals endorse it when the scenario is made personally real. Fusion ('this group IS me; an attack on them is an attack on my body') is stronger than mere identification ('I belong to this group').",
      predictors_of_real_sacrifice: "Identity fusion intensity; shared dysphoric experience (the foxhole effect); perceived familial ties; PRIOR cost paid for the group (sunk cost of loyalty); concern for saving members (it's about love, not recklessness).",
      prime_candidate: "JUDE. Highest fusion potential (the band gave him a life after prison — maximum reciprocity debt), his sacrifice carries the most narrative and psychological weight, and his testing behavior throughout was unconsciously rehearsing this exact turn: 'If I know you'll stay for me, then I can stay for you.'",
      caution_flag: "OREN's willingness to die is so indiscriminate (he'd sacrifice for a stranger) that it reads as his deepest FLAW, not just virtue — he values others over himself to a degree that worries the band. His fusion is real but his self-preservation is dangerously low."
    },

    // Bonding accelerants that RAISE fusion (and therefore real loyalty).
    fusion_accelerants: {
      foxhole_effect: "Shared adversity bonds harder than shared pleasure. Signal Decay's shared crises manufacture fusion faster than shared success would.",
      music_oxytocin: "Synchronized music-making releases oxytocin and produces physiological synchrony — a chemical intimacy that fast-tracks identification into fusion.",
      shared_meals: "Woolley & Fishbach (2019): eating the same food increases trust via perceived similarity; Dunbar (2017): shared meals predict closeness better than almost any other behavior. Zara's frequency-enhanced cooking is a daily, AMPLIFIED trust-maintenance ritual the band feels but doesn't fully understand.",
      chosen_family: "Weston (1991): chosen families (misfits who pick each other) often show STRONGER loyalty than biological ones because the choice itself carries meaning. The band CHOSE each other — that choice is load-bearing."
    },

    // Cross-cultural cohesion — why a diverse band bonds rather than fractures.
    cross_cultural_cohesion: {
      contact_conditions: "Allport (1954) / Pettigrew & Tropp (2006): intergroup contact reduces friction when four conditions hold — equal status, common goals, cooperation, institutional support. Signal Decay meets all four (no default culture, shared mission, interdependent creation, validating fan base).",
      optimal_distinctiveness: "Brewer (1999): people need to belong AND feel distinct. A band of misfits satisfies both — 'we're all outsiders, but outsiders TOGETHER.'",
      acculturation: "Berry (2005): close cross-cultural groups negotiate a NEW hybrid culture belonging to neither origin — bands do this naturally, inventing their own rituals, slang, and humor."
    }
  },
  ...
  /**
   * Get the attachment profile for a character.
   * (Real-World Psychology Enhancement — Sep 7 2026)
   * @param {string} member - Member key ("kael","mira","oren","jude","zara","lena")
   * @returns {Object|null} The character's attachment_basis profile
   */
  getAttachmentProfile: function(member) {
    if (!this.attachment_basis || !this.attachment_basis.characters) return null;
    return this.attachment_basis.characters[member] || null;
  },

  /**
   * Get the attachment interaction dynamics for a pair.
   * (Real-World Psychology Enhancement — Sep 7 2026)
   * @param {string} member1 - First member key
   * @param {string} member2 - Second member key
   * @returns {Object|null} The pair's attachment interaction profile
   */
  getPairAttachmentDynamic: function(member1, member2) {
    if (!this.attachment_basis || !this.attachment_basis.pair_dynamics) return null;
    var pd = this.attachment_basis.pair_dynamics;
    // Pair keys follow band-member order (kael,mira,oren,jude,zara), not
    // alphabetical, so try both orderings rather than sorting.
    return pd[member1 + "_" + member2] || pd[member2 + "_" + member1] || null;
  },

  /**
   * Get the story-specific trust-repair application notes.
   * (Real-World Psychology Enhancement — Sep 7 2026)
   * @param {string} scenario - "ashley_cole_betrayal","zhao_defection", or "zara_concealment"
   * @returns {string|null} The application note, or null if unknown scenario
   */
  getTrustRepairApplication: function(scenario) {
    if (!this.trust_repair_notes || !this.trust_repair_notes.story_applications) return null;
    return this.trust_repair_notes.story_applications[scenario] || null;
  },

  /**
   * Get the loyalty-under-pressure prediction for a character.
   * (Real-World Psychology Enhancement — Sep 7 2026)
   * @param {string} member - Member key ("kael","mira","oren","jude","zara")
   * @returns {string|null} How the character behaves under group pressure
   */
  getLoyaltyUnderPressure: function(member) {
    if (!this.loyalty_psychology || !this.loyalty_psychology.who_breaks_under_pressure) return null;
    return this.loyalty_psychology.who_breaks_under_pressure[member] || null;
  }
